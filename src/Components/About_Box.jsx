                        ...
                        <div className='flex ml-[1rem] sm:ml-[2rem] lg:ml-[5rem] h-full mt-[1rem] sm:mt-[2rem] md:mt-[2rem] lg:mt-[3rem] xl:mt-[5rem] 3xl:mt-[8rem] w-[30rem]'>
                            <div>
                                ...
                                <div className='mt-[1rem] xl:mt-[2rem] 3xl:mt-[3rem]'>
                                    <h1 className='text-[#1788ae] sm:text-[1.5rem] font-bold'>MERN STACK</h1>
                                    <div className='flex items-center 2xl:mt-[1rem] 3xl:mt-[1rem] gap-3 sm:gap-6'>
                                        <div className='flex flex-col items-center'>
                                            <img src={MongoDb} alt="php_img" className='w-[4rem] sm:w-[5rem] h-[6rem] sm:h-[7rem] overflow-hidden object-cover' />
                                        </div>
                                        <div className='flex flex-col items-center'>
                                            <img src={Express} alt="php_img" className='w-[3rem] sm:w-[4rem] h-[3rem] overflow-hidden' />
                                            <h1 className='text-[#111111] sm:font-bold mt-2 sm:mt-4'>Express JS</h1>
                                        </div>
                                        <div className='flex flex-col items-center'>
                                            <h1>{react}</h1>
                                            <h1 className='text-[#61dafb] sm:font-bold mt-1 sm:mt-4'>React</h1>
                                        </div>
                                        <div className='flex flex-col items-center'>
                                            <img src={Nodejs} alt="php_img" className='w-[3.5rem] overflow-hidden object-cover' />
                                            <h1 className='text-[#e44d26] sm:font-bold sm:mt-4'>Node JS</h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
